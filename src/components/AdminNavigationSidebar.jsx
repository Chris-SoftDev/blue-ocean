...
function AdminNavigationSidebar() {
  ...
  const { logout, instructor, setInstructorLoggedIn } = useContext(AuthContext);
        ...
        <div className="sidebar-nav-links">
          <div
            ...
            onClick={() => {
              ...
              setIsMaxStudentRosterVisible(false);
              setAnalyticsButtonClicked(false);
            }}
          >
          ...
          <div
            ...
            onClick={() => {
              setSelectedStudent(null);
              setIsMaxStudentRosterVisible(false);
              setAnalyticsButtonClicked(true);
            }}
          >
            <div className="sidebar-nav-link-icon">
              <svg
          ...
          <div
            ...
            onClick={() => {
              setSelectedStudent(null);
              setAnalyticsButtonClicked(false);
              setIsMaxStudentRosterVisible(true);
            }}
          >
